...
# ─── Admin hisob ma'lumotlari (production'da env variable ishlatish tavsiya etiladi) ──
ADMIN_USERNAME = "admin"
ADMIN_PASSWORD = "urganch2025"   # ← Parolni o'zgartiring!

# Flask session uchun maxfiy kalit (app.py da o'rnatiladi)
SECRET_KEY = "urganch-bus-secret-2025-xorazm"
